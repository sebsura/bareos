...
enum class autoload_result
{
  Success = 1,
  NoChangerAvailable = 0,
  ChangerError = -1,
  CouldNotLockChanger = -2,
  MediumNotFoundInSlot = -3,
};
...
slot_number_t GetAutochangerLoadedSlot(DeviceControlRecord* dcr,
                                       bool lock_set = false);
