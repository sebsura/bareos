...
template <std::size_t Size> constexpr std::size_t MinGrowthSize()
{
  ...
  std::size_t min_growth_size = 1024ull;
...
template <std::size_t Size> constexpr std::size_t MaxGrowthSize()
{
  ...
  std::size_t max_growth_size = 1024ull * 1024ull * 10ull;
...
template <typename T> class fvec : access {
 ...
 private:
  ...
  int fd{-1};
  int prot;
  static constexpr std::size_t min_growth_size = MinGrowthSize<sizeof(T)>();
  static constexpr std::size_t max_growth_size = MaxGrowthSize<sizeof(T)>();
