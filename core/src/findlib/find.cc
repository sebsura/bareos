...
std::optional<const char*> FindMatch(int (*match_func)(const char* pattern,
                                                       const char* str,
                                                       int flags),
                                     alist<const char*>& patterns,
                                     const char* str,
                                     int flags)
{
...
std::optional<const regex_t*> FindRegexMatch(alist<regex_t*>& regexs,
                                             const char* str)
{
