...
static void StoreMsgs(ConfigurationParser* p,
                      BareosResource* res,
                      LEX* lc,
                      ResourceItem* item,
                      int index)
{
  ...
  switch (static_cast<MessageDestinationCode>(item->code)) {
    ...
    case MessageDestinationCode::kSyslog: { /* syslog */
      ...
      current_char = lc->line;
      while (!done && *current_char) {
        switch (*current_char) {
          case '=':
            cnt++;
            break;
 ...
 */
static void StoreName(ConfigurationParser*,
                      BareosResource* res,
                      LEX* lc,
                      ResourceItem* item,
                      int index)
 ...
 */
static void StoreStrname(ConfigurationParser*,
                         BareosResource* res,
                         LEX* lc,
                         ResourceItem* item,
                         int index)
...
static void StoreStr(ConfigurationParser*,
                     BareosResource* res,
                     LEX* lc,
                     ResourceItem* item,
                     int index)
...
// Store a string at specified address
static void StoreStdstr(ConfigurationParser*,
                        BareosResource* res,
                        LEX* lc,
                        ResourceItem* item,
                        int index)
 ...
 */
static void StoreDir(ConfigurationParser*,
                     BareosResource* res,
                     LEX* lc,
                     ResourceItem* item,
                     int index)
...
static void StoreStdstrdir(ConfigurationParser*,
                           BareosResource* res,
                           LEX* lc,
                           ResourceItem* item,
                           int index)
...
static void StoreMd5Password(ConfigurationParser*,
                             BareosResource* res,
                             LEX* lc,
                             ResourceItem* item,
                             int index)
...
// Store a password at specified address in MD5 coding
static void StoreClearpassword(ConfigurationParser*,
                               BareosResource* res,
                               LEX* lc,
                               ResourceItem* item,
                               int index)
 ...
 * resource.
 */
static void StoreRes(ConfigurationParser* p,
                     BareosResource* res,
                     LEX* lc,
                     ResourceItem* item,
                     int index)
{
  ...
  p->AddDependency(DependencyStorageType::SINGLE, res, item, lc->str);
  ScanToEol(lc);
  item->SetPresent(res);
  ClearBit(index, res->inherit_content_);
}
 ...
 */
static void StoreAlistRes(ConfigurationParser* p,
                          BareosResource* res,
                          LEX* lc,
                          ResourceItem* item,
                          int index)
{
  ...
  while (token == BCT_COMMA) {
    ...
    p->AddDependency(DependencyStorageType::ALIST, res, item, lc->str);
...
static void StoreStdVectorStr(ConfigurationParser*,
                              BareosResource* res,
                              LEX* lc,
                              ResourceItem* item,
                              int index)
...
static void StoreAlistStr(ConfigurationParser*,
                          BareosResource* res,
                          LEX* lc,
                          ResourceItem* item,
                          int index)
 ...
 * shell later).
 */
static void StoreAlistDir(ConfigurationParser*,
                          BareosResource* res,
                          LEX* lc,
                          ResourceItem* item,
                          int index)
...
static void StorePluginNames(ConfigurationParser*,
                             BareosResource* res,
                             LEX* lc,
                             ResourceItem* item,
                             int index)
...
static void store_int32(ConfigurationParser*,
                        BareosResource* res,
                        LEX* lc,
                        ResourceItem* item,
                        int index)
...
static void store_pint16(ConfigurationParser*,
                         BareosResource* res,
                         LEX* lc,
                         ResourceItem* item,
                         int index)
...
static void store_pint32(ConfigurationParser*,
                         BareosResource* res,
                         LEX* lc,
                         ResourceItem* item,
                         int index)
...
static void store_int64(ConfigurationParser*,
                        BareosResource* res,
                        LEX* lc,
                        ResourceItem* item,
                        int index)
...
static void store_int_unit(ConfigurationParser*,
                           BareosResource* res,
                           LEX* lc,
                           ResourceItem* item,
                           int index,
  ...
  switch (token) {
    ...
    default:
      scan_err2(lc, T_("expected a %s, got: %s"),
                (type == unit_type::Size) ? T_("size") : T_("speed"), lc->str);
      return;
  }
...
// Store a size in bytes
static void store_size32(ConfigurationParser* p,
                         BareosResource* res,
                         LEX* lc,
                         ResourceItem* item,
                         int index)
{
  store_int_unit(p, res, lc, item, index, true /* 32 bit */, unit_type::Size);
}

// Store a size in bytes
static void store_size64(ConfigurationParser* p,
                         BareosResource* res,
                         LEX* lc,
                         ResourceItem* item,
                         int index)
{
  store_int_unit(p, res, lc, item, index, false /* not 32 bit */,
                 unit_type::Size);
}

// Store a speed in bytes/s
static void StoreSpeed(ConfigurationParser* p,
                       BareosResource* res,
                       LEX* lc,
                       ResourceItem* item,
                       int index)
{
  store_int_unit(p, res, lc, item, index, false /* 64 bit */, unit_type::Speed);
}

// Store a time period in seconds
static void StoreTime(ConfigurationParser*,
                      BareosResource* res,
                      LEX* lc,
                      ResourceItem* item,
                      int index)
...
static void StoreBit(ConfigurationParser*,
                     BareosResource* res,
                     LEX* lc,
                     ResourceItem* item,
                     int index)
...
static void StoreBool(ConfigurationParser*,
                      BareosResource* res,
                      LEX* lc,
                      ResourceItem* item,
                      int index)
...
static void StoreLabel(ConfigurationParser*,
                       BareosResource* res,
                       LEX* lc,
                       ResourceItem* item,
                       int index)
 ...
 *   = { ipv4 { port = 4711 } }
 */
static void StoreAddresses(ConfigurationParser*,
                           BareosResource* res,
                           LEX* lc,
                           ResourceItem* item,
                           int index)
{
  ...
  do {
    ...
    if (!AddAddress(GetItemVariablePointer<dlist<IPADDR>**>(res, *item),
...
static void StoreAddressesAddress(ConfigurationParser*,
                                  BareosResource* res,
                                  LEX* lc,
                                  ResourceItem* item,
                                  int)
{
  ...
  if (!AddAddress(GetItemVariablePointer<dlist<IPADDR>**>(res, *item),
                  ...
                  strchr(lc->str, ':') ? AF_INET6 : AF_INET, lc->str, 0, errmsg,
                  sizeof(errmsg))) {
    scan_err2(lc, T_("can't add port (%s) to (%s)"), lc->str, errmsg);
  }
}

static void StoreAddressesPort(ConfigurationParser*,
                               BareosResource* res,
                               LEX* lc,
                               ResourceItem* item,
                               int)
                                        ...
                                        int index)
{
  switch (type) {
    case CFG_TYPE_STR:
      StoreStr(this, res, lc, item, index);
      break;
    case CFG_TYPE_DIR:
      StoreDir(this, res, lc, item, index);
      break;
    case CFG_TYPE_STDSTR:
      StoreStdstr(this, res, lc, item, index);
      break;
    case CFG_TYPE_STDSTRDIR:
      StoreStdstrdir(this, res, lc, item, index);
      break;
    case CFG_TYPE_MD5PASSWORD:
      StoreMd5Password(this, res, lc, item, index);
      break;
    case CFG_TYPE_CLEARPASSWORD:
      StoreClearpassword(this, res, lc, item, index);
      break;
    case CFG_TYPE_NAME:
      StoreName(this, res, lc, item, index);
      break;
    case CFG_TYPE_STRNAME:
      StoreStrname(this, res, lc, item, index);
      break;
    case CFG_TYPE_RES:
      StoreRes(this, res, lc, item, index);
      break;
    case CFG_TYPE_ALIST_RES:
      StoreAlistRes(this, res, lc, item, index);
      break;
    ...
    case CFG_TYPE_STR_VECTOR_OF_DIRS:
      StoreStdVectorStr(this, res, lc, item, index);
      break;
    case CFG_TYPE_ALIST_DIR:
      StoreAlistDir(this, res, lc, item, index);
      break;
    case CFG_TYPE_INT16:
      store_int16(this, res, lc, item, index);
      break;
    case CFG_TYPE_PINT16:
      store_pint16(this, res, lc, item, index);
      break;
    case CFG_TYPE_INT32:
      store_int32(this, res, lc, item, index);
      break;
    case CFG_TYPE_PINT32:
      store_pint32(this, res, lc, item, index);
      break;
    case CFG_TYPE_MSGS:
      StoreMsgs(this, res, lc, item, index);
      break;
    case CFG_TYPE_INT64:
      store_int64(this, res, lc, item, index);
      break;
    case CFG_TYPE_BIT:
      StoreBit(this, res, lc, item, index);
      break;
    case CFG_TYPE_BOOL:
      StoreBool(this, res, lc, item, index);
      break;
    case CFG_TYPE_TIME:
      StoreTime(this, res, lc, item, index);
      break;
    case CFG_TYPE_SIZE64:
      store_size64(this, res, lc, item, index);
      break;
    case CFG_TYPE_SIZE32:
      store_size32(this, res, lc, item, index);
      break;
    case CFG_TYPE_SPEED:
    ...
    case CFG_TYPE_ADDRESSES:
      StoreAddresses(this, res, lc, item, index);
      break;
    case CFG_TYPE_ADDRESSES_ADDRESS:
      StoreAddressesAddress(this, res, lc, item, index);
      break;
    case CFG_TYPE_ADDRESSES_PORT:
      StoreAddressesPort(this, res, lc, item, index);
      break;
    case CFG_TYPE_PLUGIN_NAMES:
      StorePluginNames(this, res, lc, item, index);
      break;
