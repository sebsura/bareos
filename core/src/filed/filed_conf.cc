...
static ResourceItem cli_items[] = {
  ...
  {"LogTimestampFormat", CFG_TYPE_STR, ITEM(res_client, log_timestamp_format_remove_in_24), 0, CFG_ITEM_DEFAULT|CFG_ITEM_DEPRECATED, TimestampFormat::Default, "15.2.3-", NULL},
