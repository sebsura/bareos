...
int SaveFile(JobControlRecord* jcr, FindFilesPacket* ff_pkt, bool top_level);
	int SaveFile2(JobControlRecord* jcr, FindFilesPacket* ff_pkt, bool has_file_data, bool top_level);
...
int SaveFile2(JobControlRecord* jcr, FindFilesPacket* ff_pkt, bool,
	      bool has_file_data)
{
  b_save_ctx bsctx;
