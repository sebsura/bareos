...
class TestBareosFd(unittest.TestCase):
    ...
    def test_RestorePacket(self):
        ...
        self.assertEqual(
            'RestorePacket(stream=0, data_stream=0, type=0, file_index=0, linkFI=0, uid=0, statp=None, attrEx="", ofname="", olname="", where="(null)", RegexWhere="(null)", replace=0, create_status=0)',
