 ...
 */
int BareosDb::DeleteNullJobmediaRecords(JobControlRecord* jcr, std::uint32_t jobid)
{
  DbLocker _{this};

  Mmsg(cmd, "DELETE FROM jobmedia WHERE jobid=%u AND firstindex=0 AND lastindex=0", jobid);
