...
{
    public const BNET_TLS_NONE = 0;   /* cannot do TLS */
    public const BNET_TLS_OK = 1;      /* can do, but not required on my end */
    public const BNET_TLS_REQUIRED = 2;   /* TLS is required */

    public const BNET_EOD = -1;      /* End of data stream, new data may follow */
    public const BNET_EOD_POLL = -2;   /* End of data and poll all in one */
    public const BNET_STATUS = -3;      /* Send full status */
    public const BNET_TERMINATE = -4;   /* Conversation terminated, doing close() */
    public const BNET_POLL = -5;      /* Poll request, I'm hanging on a read */
    public const BNET_HEARTBEAT = -6;   /* Heartbeat Response requested */
    public const BNET_HB_RESPONSE = -7;   /* Only response permited to HB */
    public const BNET_xxxxxxPROMPT = -8;   /* No longer used -- Prompt for subcommand */
    public const BNET_BTIME = -9;      /* Send UTC btime */
    public const BNET_BREAK = -10;      /* Stop current command -- ctl-c */
    public const BNET_START_SELECT = -11;   /* Start of a selection list */
    public const BNET_END_SELECT = -12;   /* End of a select list */
    public const BNET_INVALID_CMD = -13;   /* Invalid command sent */
    public const BNET_CMD_FAILED = -14;   /* Command failed */
    public const BNET_CMD_OK = -15;   /* Command succeeded */
    public const BNET_CMD_BEGIN = -16;   /* Start command execution */
    public const BNET_MSGS_PENDING = -17;   /* Messages pending */
    public const BNET_MAIN_PROMPT = -18;   /* Server ready and waiting */
    public const BNET_SELECT_INPUT = -19;   /* Return selection input */
    public const BNET_WARNING_MSG = -20;   /* Warning message */
    public const BNET_ERROR_MSG = -21;   /* Error message -- command failed */
    public const BNET_INFO_MSG = -22;   /* Info message -- status line */
    public const BNET_RUN_CMD = -23;   /* Run command follows */
    public const BNET_YESNO = -24;      /* Request yes no response */
    public const BNET_START_RTREE = -25;   /* Start restore tree mode */
    public const BNET_END_RTREE = -26;   /* End restore tree mode */
    public const BNET_SUB_PROMPT = -27;   /* Indicate we are at a subprompt */
    public const BNET_TEXT_INPUT = -28;   /* Get text input from user */
